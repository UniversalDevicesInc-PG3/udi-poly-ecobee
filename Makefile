# udi-poly-ecobee — lint/test, PG3 release artifacts (tag + per-track zips).
#
...
help:
	...
	@echo "  make test-unit           Exclude integration tests"
	@echo ""
...
# Run from this directory, or: make -C /path/to/udi-poly-ecobee release
...
.PHONY: check xml-check test test-unit help clean zip beta production release
